...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateLanguage(language) {
        if (language == 'en') {
			...
			text2.innerText = 'copiare il testo dal documento esterno OPPURE';
			...
			text6.innerText = "Selezionare o copiare un link e cliccare qui sotto per aprirlo in uno dei proxy online di Browserling (con limitazioni).";
			unS.innerText = "ESPANSIONE URL";
			text7.innerText = "Selezionare o copiare il link abbreviato e cliccare un pulsante sotto per scoprirne l'indirizzo esteso.";
			chU.innerText = "CONTROLLO INDIRIZZO";
			text8.innerText = "Selezionare o copiare l'indirizzo completo e cliccare un pulsante sotto per verificare la reputazione o se è online o se ci sono versioni archiviate.";
